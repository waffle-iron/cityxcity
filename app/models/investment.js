...
export default DS.Model.extend({
  ...
  investment_type: DS.attr('text'),
  product_massdev: DS.attr('text'),
  product_public: DS.attr('text'),
  product_private: DS.attr('text'),
  ...
  amount_estimated: DS.attr('text'),
  investment_status: DS.attr('json'),
